...
> | 英文名 | TransparentHer |
> | 开发 | **可味玩KawayiPlay** |
> | 发行 | **可味玩KawayiPlay**（自研自发） |
> | Steam | [AppID 3021350](https://store.steampowered.com/app/3021350/) |
> | 发售 | 2025 年 9 月 22 日 |
>
> **这个模组是玩家自制的第三方工具，与可味玩KawayiPlay 没有任何关系，
...
> 我们欠你们一句道歉。
>
> 做这个模组的过程中，我们反编译了你们的游戏（`Assembly-CSharp.dll`）、
> 解包了 Addressables、把剧本文字提取了出来 —— **这些都没有事先问过你们。**
>
> 技术上这是绕不开的一步：这个游戏把一部分界面文字画成了图片，选项按钮又按
> 屏幕坐标散落摆放，不反编译就找不到能挂钩子的地方。但**"必要"不等于"可以不打招呼"**。
> 我们做这件事的出发点不是不尊重这部作品，恰恰相反 ——
> 是因为觉得它值得被更多人玩到，才想让读屏玩家也能走完一遍。
>
> 已经做的补救：
>
> - 提取的剧本与反编译的代码**从未进入版本库**（全历史核查过，含其它分支），
